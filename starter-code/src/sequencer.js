  ...
  createSequence(sequence){
    ...
    for (let i = 0; i < characters.length; i++){
      ...
      if (currentChar !== nextChar && repeatCount >= 1){
        ...
        containerString = [...containerString, ...(repeats + currentChar)].join("");
  ...
  decodeSequence (sequence) {
    ...
    for (let i = 0; i < characters.length; i++){
      ...
      if (!isNaN(characters[i])){
        ...
        containerString = [...containerString, ...letters];
      ...
      // it must be a lone letter
        ...
        containerString = [...containerString,characters[i]];
      }
    }

    return containerString.join("");
  }
